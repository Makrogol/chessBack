...
from game.board import PieceTypeAndColor, BoardRepresentation
...
class ChessUnparser():
    ...
    def possible_moves(self, possible_moves_str: bytearray) -> list[Position]:
        possible_moves = possible_moves_str.decode('utf-8').split(':')[1].split(';')
        return [self.position(move) for move in possible_moves]
