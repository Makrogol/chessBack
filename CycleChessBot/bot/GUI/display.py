...
class GUI:
    ...
    def start(self) -> None:
        ...
        self.gameboard = Board(
            colors, BGCOLOR, self.DISPLAYSURF, self.WINDOWWIDTH, self.WINDOWHEIGHT, self.fen)
        ...
        for event in pygame.event.get():
            if event.type == MOUSEBUTTONUP:
                ...
                if event.button == 3:
                    ...
                    if piece.piece_type == PieceType.PAWN and ((piece.color == Color.WHITE and self.position_second.i == 7) or (piece.color == Color.BLACK and self.position_second.i == 0)):
